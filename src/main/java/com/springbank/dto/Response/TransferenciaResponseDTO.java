...
public class TransferenciaResponseDTO {
    ...
    public TransferenciaResponseDTO(Long id, BigDecimal monto, TipoTransaccion tipo, Long cuentaOrigenId, Long cuentaDestinoId, EstadoTransaccion estado, String motivo, LocalDateTime fecha) {
        this.id = id;
        this.monto = monto;
        this.tipo = tipo;
